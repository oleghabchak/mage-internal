...
interface WeekCompleteEmptyContentProps {}

export const WeekCompleteEmptyContent: React.FC<WeekCompleteEmptyContentProps> = observer(
  function WeekCompleteEmptyContent() {
    const {
