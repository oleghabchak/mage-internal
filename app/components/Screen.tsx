...
export function Screen(props: ScreenProps) {
  const { backgroundColor, KeyboardAvoidingViewProps, keyboardOffset = 200, StatusBarProps } = props
  const { colors } = useTheme() as ColorsInterface
  return (
    <View style={[$containerStyle, { backgroundColor: backgroundColor || colors.background }]}>
      <StatusBar style={colors.text === palette.black ? "dark" : "light"} {...StatusBarProps} />
