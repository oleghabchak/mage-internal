  ...
  return (
    <View>
      ...
      {item.useCases.map((u) => {
        ...
        return (
          <Link key={generateUUID()} to={`/showroom/${sectionSlug}/${itemSlug}`}>
            <Text>{u}</Text>
          </Link>
        )
      })}
...
export const DemoShowroomScreen: FC<DemoTabScreenProps<"DemoShowroom">> =
  function DemoShowroomScreen(_props) {
    ...
    useHeader(
      {
        title: "Home",
        subtitle: "Here is your next workout",
        titleStyle: {
          fontSize: spacing.lg,
        },
        hideBackBtn: true,
    ...
    return (
      ...
      >
        <Screen statusBarStyle="dark" preset="fixed" contentContainerStyle={$screenContainer}>
